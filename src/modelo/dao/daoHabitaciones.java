...
public class daoHabitaciones {
    ...
    public List<Habitaciones> getAll() {
        ...
        String sql = "SELECT idhabitaion, typehabitacion, precioxnoche, estado FROM habitaciones";
        ...
        for (Object[] fila : resultados) {
            ...
            habitacion.setIdhabitaion((int) fila[0]);
    ...
    public int insertarHabitacion(Habitaciones habitacion) {
        operacionesBD op = new operacionesBD();
        String sql = "INSERT INTO habitaciones (typehabitacion, precioxnoche, estado) VALUES ('" + habitacion.getTypehabitacion() + "', " + habitacion.getPrecioxnoche() + ", '" + habitacion.getEstado() + "')";
    ...
    public int actualizarHabitacion(Habitaciones habitacion) {
        String sql = "UPDATE habitaciones SET typehabitacion='" + habitacion.getTypehabitacion() + "', precioxnoche=" + habitacion.getPrecioxnoche() + ", estado='" + habitacion.getEstado() + "' WHERE idhabitaion=" + habitacion.getIdhabitaion();
        operacionesBD op = new operacionesBD();
        return op.ejecutar(sql);
    }
    ...
    public int eliminarHabitacion(int id) {
        String sql = "DELETE FROM habitaciones WHERE idhabitaion=" + id;
        operacionesBD op = new operacionesBD();
        return op.ejecutar(sql);
    }
    ...
    public Habitaciones getHabitacionByID(int idHabitacion) {
        ...
        String sql = "SELECT idhabitaion, typehabitacion, precioxnoche, estado FROM habitaciones WHERE idhabitaion = " + idHabitacion;
        operacionesBD op = new operacionesBD();
